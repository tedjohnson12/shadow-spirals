...
for i in np.arange(100, 400, 1):
    ...
    ax.plot(ln_r,anomaly_narrow[I_PHI,:],lw=1,c=colors.dark_orange,alpha=0.05)
...
ax.add_patch(patches.Rectangle((0,0),np.nan,np.nan,color=colors.dark_orange,label='Narrow'))
